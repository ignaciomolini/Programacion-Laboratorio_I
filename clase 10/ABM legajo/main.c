...
void mostrarAlumno(eAlumno x)
{
    printf(" %d  %8s    %d    %c     %2d     %2d     %3.2f    %02d/%02d/%d\n",
           x.legajo,
           x.nombre,
           x.edad,
           x.sexo,
...
int hardcodearAlumnos( eAlumno vec[],int tam, int cantidad)
{
    ...
    eAlumno suplentes[] =
    {
        {20000, "Juan", 20, 'm', 5, 7, 6, {12, 5, 2016}, 0},
        {20001, "Alberto", 21, 'm', 2, 8, 5, {12, 4, 2013}, 0},
        {20002, "Ana", 22, 'f', 4, 5, 4.5, {12, 1, 2017}, 0},
        {20003, "Luis", 20, 'm', 9, 8, 8.5, {12, 6, 2018}, 0},
        {20004, "Alicia", 21, 'f', 6, 7, 6.5, {12, 8, 2011}, 0},
        {20005, "Diego", 23, 'm', 2, 2, 2, {12, 3, 2008}, 0},
        {20006, "Sofia", 19, 'f', 8, 9, 8.5, {12, 8, 2014}, 0},
        {20007, "Clara", 21, 'f', 2, 4, 3, {12, 12, 2013}, 0},
        {20008, "Mauro", 20, 'm', 4, 7, 5.5, {12, 8, 2011}, 0},
        {20009, "Daniela", 22, 'f', 5, 7, 6, {12, 9, 2014}, 0},
        {20010, "Agustin", 24, 'm', 5, 7, 6, {12, 5, 2015}, 0},
    };
