...
int esSoloLetra(char car);


void mostrarAlumno(eAlumno x, eCarrera carreras[], int tamC)
{
    char descCarrera[20];

    cargarDescCarrera(x.idCarrera, carreras, tamC, descCarrera);
